 ...
 * Section 01 — Hero.
 *
 * Rebuilt 2026-09-15 — replaces the scroll-scrubbed logo-reveal canvas
 ...
 * "an amazing welcome," not a mechanism the visitor has to operate.
 */
export function CinematicHero() {
  return (
    <div className="relative w-full">
      <div className="relative h-[62svh] min-h-[380px] w-full overflow-hidden bg-white sm:h-[74svh]">
        <video
          autoPlay
          muted
          loop
