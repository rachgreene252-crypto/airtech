          ...
          <div>
            ...
            <div className="mt-8">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full bg-(--color-brand-blue) px-5 py-2.5 text-sm font-semibold text-white shadow-[0_1px_2px_rgba(0,0,0,0.2)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-(--color-brand-blue-hover) hover:shadow-[0_10px_24px_-8px_rgba(63,166,231,0.6)]"
              >
                Enquire
