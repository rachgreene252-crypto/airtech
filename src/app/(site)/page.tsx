...
// hero per direct feedback), SystemsReveal ("what Airtech does"), BuiltForNepal
// ("that Nepali essence"), BuildingFor (sector carousel), ClientJourney (the
// process timeline), TrustedBy (client logos), FinalCTA.
